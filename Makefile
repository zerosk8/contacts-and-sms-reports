...
TEST_UTILS_STRING = test_utils_string
TEST_UTILS_FILE_SYSTEM = test_utils_file_system
...
$(EXE_TEST): $(PATH_BUILD) $(PATH_BUILD_TEST) $(PATH_BIN_TEST) \
	...
	$(CLASS_SMS).$(FILE_EXT_BUILD) \
	$(CLASS_CONTACT).$(FILE_EXT_BUILD) \
	...
	$(PATH_TEST)/$(TEST_SMS).$(FILE_EXT_SRC) \
	$(PATH_TEST)/$(TEST_CONTACT).$(FILE_EXT_SRC) \
	$(PATH_TEST)/$(TEST_UTILS_STRING).$(FILE_EXT_SRC) \
	$(PATH_TEST)/$(TEST_UTILS_FILE_SYSTEM).$(FILE_EXT_SRC)
